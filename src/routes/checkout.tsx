  ...
  head: () => ({
    meta: [
      { title: "Knowledge Base Access, AED 299 | UAEworkrights" },
      {
        name: "description",
        content:
          "Unlock 30-day access to the UAEworkrights knowledge base. UAE settlement guides by jurisdiction: mainland, DIFC, ADGM, free zones. AED 299.",
      },
    ...
    links: [{ rel: "canonical", href: "https://uaeworkrights.com/checkout" }],
  }),
...
function CheckoutPlaceholder() {
  return (
    <main
      className="flex min-h-dvh flex-col items-center justify-center px-6 py-24"
    ...
    >
      ...
      >
        ...
        >
          Payment processing is being set up. In the meantime, contact us directly to arrange
          access.
        </p>
        <Link
          to="/contact"
