    ...
    >
      ...
      <div className="relative mx-auto max-w-4xl">
        <div className="mb-12 text-center">
          ...
          >
            Enter your basic salary and years of service. See what UAE labour law says you&apos;re
            owed.
          </p>
        </div>
        ...
        >
          ...
          <div className="relative" style={{ zIndex: 1 }}>
            ...
            <div className="mt-10 text-center">
              ...
              >
                MOHRE mainland formula. 21 days basic salary per year for first 5 years, 30 days
                after that.
              </p>
            </div>
