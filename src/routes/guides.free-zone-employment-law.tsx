  ...
  head: () => ({
    meta: [
      { title: "Do Free Zones Have Their Own Employment Law? The Actual Answer | UAEworkrights" },
      {
        name: "description",
        content:
          "JAFZA, DMCC, DAFZA and most UAE free zones follow federal law (FDL 33/2021). Exactly two exceptions, DIFC and ADGM, change your gratuity, courts, and non-compete rules. Here's the one-line test.",
      },
      {
        property: "og:title",
        content: "Do Free Zones Have Their Own Employment Law? Here's the Actual Answer",
      },
      {
        ...
        <div className="mt-10 space-y-10">
          <section>
            <p className="font-sans" style={{ fontSize: "16px", lineHeight: 1.75, color: INK }}>
              ...
              registered in one of these zones, your gratuity, notice period, and termination rights
              are calculated exactly the same way as a mainland employee's.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="mt-4 space-y-2.5">
              {[
                <>
                  Your end-of-service benefit likely isn't calculated as traditional gratuity at
                  all: DIFC uses <strong>DEWS</strong> (a funded savings scheme with employer
                  contributions), and ADGM has adopted a similar model.
                </>,
                <>
                  Disputes go to the <strong>DIFC Courts or ADGM Courts</strong>, not MOHRE or the
                  mainland labour courts.
                </>,
                <>
                  Non-compete clauses are assessed differently: common law courts tend to enforce
                  them more readily than UAE Labour Law does.
                </>,
              ].map((item, i) => (
                <li
                  key={i}
          ...
          >
            ...
            >
              ...
              almost certainly under the same federal law as everyone else, regardless of which free
              zone your employer is registered in.
            </p>
          </section>
          ...
          <section>
            ...
            >
              This is general guidance, not a substitute for a review of your specific contract. If
              you're not sure which framework applies to you, that's exactly what a contract or
