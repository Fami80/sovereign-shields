      ...
      <div className="relative mx-auto max-w-6xl px-6 pt-24 pb-20 md:pt-32 md:pb-28">
        <div className="flex flex-col items-start gap-6">
          ...
          <h1 className="max-w-3xl text-4xl font-extrabold leading-[1.05] tracking-tight md:text-6xl">
            Settle disputes with the precision of a{" "}
            <span className="text-action-accent">sovereign</span> legal desk.
          </h1>

          <p className="max-w-2xl text-base text-text-muted-dark md:text-lg">
          ...
          <div className="mt-4 flex w-full flex-col gap-3 sm:flex-row sm:w-auto">
            <a
              href="#vault"
            ...
            <a
              href="#vault"
              className="inline-flex items-center justify-center gap-2 rounded-full border border-action-accent/70 bg-transparent px-6 py-3.5 text-sm font-semibold text-text-dark-primary transition-all duration-300 hover:scale-[1.02] hover:bg-action-accent/10"
            >
