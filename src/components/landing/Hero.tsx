        ...
        <div className="flex flex-col items-start">
          ...
          <div className="mt-7 flex w-full flex-col gap-3 sm:flex-row sm:w-auto">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group inline-flex w-full items-center justify-center gap-2 rounded-full px-6 py-3.5 font-sans transition-transform duration-150 ease-out hover:scale-[1.02] focus-visible:[outline:2px_solid_#1E0A0E] focus-visible:[outline-offset:2px] sm:w-auto"
              style={{
