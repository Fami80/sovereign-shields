              ...
              itemListElement: [
                {
                  ...
                  position: 1,
                  name: "Home",
                  item: "https://uaeworkrights.com/",
                },
                {
                  "@type": "ListItem",
                  position: 2,
                  name: "UAE gratuity calculation guide",
                  item: CANONICAL,
                },
              ],
            },
    ...
    >
      ...
      <main className="mx-auto max-w-[720px] px-6 pb-24 pt-20">
        ...
        <p className="mt-5 font-sans" style={{ fontSize: "17px", lineHeight: 1.75, color: INK }}>
          If you've just received a settlement or end-of-service letter, the gratuity line is where
          most errors hide. This guide walks through the mainland (MOHRE) formula under Federal
          Decree-Law No. 33 of 2021, in plain language, with a worked example, so you can check the
          number yourself before you sign anything.
        </p>
        ...
        <div className="mt-12 space-y-12">
          ...
          <section>
            ...
            <P>
              Gratuity is calculated on your <strong>basic salary only</strong>: housing, transport,
              and other allowances are excluded. Two errors to watch for. First, some letters
              quietly use a number lower than your actual contractual basic. Second, if you had
              raises, the calculation must use your <strong>last</strong> basic salary, not an old
              one. Check the basic salary shown on your letter against your most recent contract or
              salary certificate.
            </P>
          </section>
          ...
          <section>
            ...
            <Ul
              items={[
                ...
                <>
                  For each of the first 5 years of service: <strong>21 days</strong> of that daily
                  wage.
                </>,
                <>
                ...
                <>
                  Part years count pro-rata (e.g. 3.5 years = 3 years + half of a year's
                  entitlement).
                </>,
            ...
            <div
              ...
              style={{
                backgroundColor: "rgba(139,45,58,0.06)",
            ...
            >
              ...
              <p
                ...
                style={{ fontSize: "15px", lineHeight: 1.8, color: INK }}
              >
          ...
          <section>
            ...
            <P>
              This is the change most people, and some employers, haven't caught up with. Under the
              old law, resigning before 5 years reduced your gratuity to a fraction. Federal
          ...
          <section>
            ...
            <Ul
              items={[
                <>
                  <strong>Unpaid leave</strong>: days of unpaid leave don't count toward your
                  service period.
                </>,
                <>
                  <strong>Amounts you owe your employer</strong>: documented debts (e.g. a salary
                  advance) can be deducted from the end-of-service settlement.
                </>,
                <>
            ...
            <p
              ...
              style={{ fontSize: "16px", lineHeight: 1.75, color: INK }}
            >
          ...
          <section>
            ...
            <P>
              ...
              contributions into a savings plan instead, and you can check the balance in the Zurich
              portal. <strong>ADGM</strong> and several free zones have their own employment
              frameworks. If your contract is in one of these jurisdictions, the mainland formula on
              your letter may itself be the error.
            </P>
          </section>
              ...
              {FAQ.map((f) => (
                <div key={f.q}>
                  ...
                  <p
                    ...
                    style={{ fontSize: "15px", lineHeight: 1.7, color: INK }}
                  >
                    {f.a}
                  </p>
                </div>
          ...
          >
            ...
            >
              Kaoutar personally checks your settlement letter against UAE Labour Law: every line,
              your jurisdiction, with written findings in 48 hours. AED 999 flat.
            </p>
            <a
          ...
          <p
            className="font-sans"
            style={{ fontSize: "13px", lineHeight: 1.6, color: "rgba(30,10,14,0.7)" }}
          >
            This guide is general information about mainland UAE employment, not legal advice. Last
            reviewed July 2026 against Federal Decree-Law No. 33 of 2021.
          </p>
        </div>
      </main>
      <SiteFooter />
